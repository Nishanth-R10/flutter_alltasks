      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const QuickActions(),
              SizedBox(height: MediaQueryUtils.h(16)), // Reduced from 24 to 16
              ...
              SizedBox(height: MediaQueryUtils.h(12)), // Kept 12 for content spacing
              const ReferEarnCard(),
              
              // NAVIGATION SECTION
              SizedBox(height: MediaQueryUtils.h(16)), // Reduced from 30 to 16
          ...
          children: [
            ...
            Expanded(
              child: _navigationButton(
                ...
                onTap: () => context.pushRoute(const FinancialServicesRoute()),
              ),
            ),
          ],
        ),
          ...
          children: [
            Expanded(
              child: _navigationButton(
                ...
                onTap: () => context.pushRoute(const NewUserSearchRoute()),
              ),
            ),
            SizedBox(width: MediaQueryUtils.w(12)),
            Expanded(
              child: _navigationButton(
                ...
                onTap: () => context.pushRoute(const ReturningUserSearchRoute()),
              ),
            ),
          ],
        ),
