...
_$InvestmentOfferEntityImpl _$$InvestmentOfferEntityImplFromJson(
...
Map<String, dynamic> _$$InvestmentOfferEntityImplToJson(
  _$InvestmentOfferEntityImpl instance,
) => <String, dynamic>{
  'id': instance.id,
