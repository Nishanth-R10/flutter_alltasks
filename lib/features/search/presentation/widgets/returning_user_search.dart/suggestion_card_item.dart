    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Image container - RECTANGULAR and LEFT ALIGNED
            Container(
              width: baseSize * 35, // Bigger width
              height: baseSize * 25, // Bigger height
              alignment: Alignment.centerLeft,
              child: Image.asset(
                'assets/images/discovery.png',
                width: baseSize * 35, // Big image width
                height: baseSize * 25, // Big image height
                fit: BoxFit.contain,
                alignment: Alignment.centerLeft,
              ),
            ),
